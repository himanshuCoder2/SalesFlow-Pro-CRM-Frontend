...
function Toggle({ defaultOn = false }: { defaultOn?: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`absolute top-[2px] h-5 w-5 rounded-full bg-white border border-gray-300 transition-transform ${
...
const accountItems = [
  ...
  },
  {
    ...
    desc: "Manage sales team and roles",
  },
];
...
const securityItems = [
  ...
  },
  {
    ...
    desc: "Currently enabled via SMS",
  },
];
...
const privacyItems = [
  {
    ...
    desc: "Download your CRM history",
  },
  {
    href: "/settings",
    icon: "policy",
    label: "Privacy Policy",
    desc: "View our terms and conditions",
  },
];
      ...
      <div className="bg-white border-y border-primary/5">
        {items.map((item, i) => (
          <div key={item.label}>
            ...
            {i < items.length - 1 && (
              <div className="h-px bg-primary/5 ml-20" />
            )}
          </div>
        ))}
      </div>
          ...
          <div className="bg-white border-y border-primary/5">
            {[
              ...
              <div key={item.label}>
                ...
                {i === 0 && <div className="h-px bg-primary/5 ml-20" />}
              </div>
            ))}
          </div>
        </section>
